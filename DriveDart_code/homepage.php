...
<!--HEADER SECTIO STARTS-->
    ...
    <div class="username">
      ...
      <a href="logout.php" style="font-size:2rem; font-weight:bold; text-decoration:none; color:black;">Logout</a>
    </div>
...
<section class="home" id="home">
    ...
    <a href="search.html" class="btn home-parallax" data-speed="7">Book Now</a>
